...
function App() {
  ...
  const [currentFilter,setCurrentFilter]= useState({
    mainItems:'All',
    subItems:'All' // stating my filtered products as All initially
  });
  const handleCategorySelect = (mainItems, subItems) => {
    ...
    //USING COMPARISON LOGIC FOR FILTERING THE PRODUCTS BASED ON CATEGORY AND SUBCATEGORY
    // === WE HAVE TO USE STRICT COMPARISON INSTEAD OF == TO AVOID TYPE COERCION ISSUES
    // MAYBE IMPROVEMENTS NEEDED HERE TOO
    if (mainItems === 'All') {
